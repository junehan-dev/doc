...
| 컨테이너 기반 어플리케이션을 공급하기 위해서, 많은 도구들이 개발되었는데, *Docker*\와 구글의 *Kubernetes*\프로젝트에서, *Lyft's Envoy service mesh* 그리고 *Neflix's Spinnaker*\까지 다양하다.
| 당신이 어느 분야에서 일을 하고 있던지, 당신은 넓고 깊이있는 많은 개념을 알아야 *container-based environments*\를 관리할 수 있다.

*Docker for developers*\에서는
